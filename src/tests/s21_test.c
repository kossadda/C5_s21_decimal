...
START_TEST(add_all_1) {
    s21_decimal m1[] = {{{0, 100, 0, e1 | MINUS}},
                        {{523798, 0, 0, e1 | MINUS}},
                        ...
                        {{0, UINT_MAX, 100, 0 | MINUS}},
                        {{UINT_MAX, 523798, 0, 0 | MINUS}},
                        {{UINT_MAX, UINT_MAX, 0, 0 | MINUS}},
                        {{UINT_MAX, 1, 0, 0 | MINUS}},
                        {{UINT_MAX, 100, 0, 0 | MINUS}},
                        {{523798, 523798, 523798, 0 | MINUS}},
                        {{UINT_MAX, 0, 100, 0 | MINUS}},
                        {{1, 0, 1, 0 | MINUS}},
                        {{325, 9999, 0, 0 | MINUS}},
                        {{1, 1, 1, 0 | MINUS}},
                        {{UINT_MAX, UINT_MAX, UINT_MAX, 0 | MINUS}},
                        {{2136, 12366, 21355, 0 | MINUS}},
                        {{999999, 999999, 999999, 0 | MINUS}},
                        {{0, 0, 523798, e1 | MINUS}},
                        {{0, 0, UINT_MAX, e1 | MINUS}},
                        {{0, 0, 1, e1 | MINUS}},
                        {{0, 0, 100, e1 | MINUS}},
                        {{0, 523798, 0, e1 | MINUS}},
                        {{0, UINT_MAX, 0, e1 | MINUS}},
                        {{0, 1, 0, e1 | MINUS}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0}},
                        {{99999999, 0, 432680, 0}},
...
START_TEST(add_all_2) {
    s21_decimal m1[] = {{{0, 100, 0, e1}},
                        ...
                        {{0, UINT_MAX, 0, e1}},
                        {{0, 1, 0, e1}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0 | MINUS}},
                        {{1453254535, 2123413241, 21367563, 0 | MINUS}},
                        {{99999999, 0, 432680, 0 | MINUS}},
                        {{5555, 9999999, 0, 0 | MINUS}},
                        {{1, 1, 1, 0 | MINUS}},
                        {{0, 1, 0, 0 | MINUS}},
                        {{UINT_MAX, UINT_MAX, 0, 0 | MINUS}},
                        {{UINT_MAX, 2, 12343214, 0 | MINUS}},
                        {{1234, 1234569, 0, 0 | MINUS}},
                        {{22222, 13, 132154, 0 | MINUS}},
                        {{UINT_MAX, 4312, 4291264512, 0 | MINUS}},
                        {{2111111, 112312366, 121355, 0 | MINUS}},
                        {{1, 0, 0, e1 | MINUS}}};
    int size_m1 = sizeof(m1) / sizeof(m1[0]);
    int size_m2 = sizeof(m2) / sizeof(m2[0]);
    test_add(m1, m2, size_m1, size_m2);
...
START_TEST(mul_all_1) {
    s21_decimal m1[] = {{{100, 0, 0, 0}}, {{0, UINT_MAX, 523798, e1 * 2}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0}},
                        {{99999999, 0, 432680, 0}},
                        {{5555, 9999999, 0, 0}},
...
START_TEST(mul_all_2) {
    s21_decimal m1[] = {{{0, UINT_MAX, 100, 0}},
                        {{UINT_MAX, 523798, 0, 0}},
                        {{UINT_MAX, UINT_MAX, 0, 0}},
                        {{UINT_MAX, 1, 0, 0}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
...
START_TEST(mul_all_3) {
    s21_decimal m1[] = {{{UINT_MAX, 100, 0, 0}},
                        {{523798, 523798, 523798, 0}},
                        {{UINT_MAX, 0, 100, 0}},
                        {{1, 0, 1, 0 | MINUS}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
...
START_TEST(mul_all_4) {
    s21_decimal m1[] = {{{325, 9999, 0, 0}},
                        {{1, 1, 1, 0}},
                        {{UINT_MAX, UINT_MAX, UINT_MAX, 0}},
                        {{2136, 12366, 21355, 0 | MINUS}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
...
START_TEST(mul_all_5) {
    s21_decimal m1[] = {{{999999, 999999, 999999, 0 | MINUS}},
                        {{0, 0, 523798, e1 | MINUS}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0}},
                        {{99999999, 0, 432680, 0 | MINUS}},
...
START_TEST(mul_all_6) {
    s21_decimal m1[] = {{{0, 0, 100, e1}}, {{0, 523798, 0, e1 | MINUS}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0 | MINUS}},
                        {{99999999, 0, 432680, 0}},
                        {{5555, 9999999, 0, 0}},
...
START_TEST(mul_all_7) {
    s21_decimal m1[] = {{{0, UINT_MAX, UINT_MAX, 0 | MINUS}},
                        {{0, UINT_MAX, 1, 0}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0}},
                        {{99999999, 0, 432680, 0}},
...
START_TEST(mul_all_8) {
    s21_decimal m1[] = {{{0, 0, UINT_MAX, e1}}, {{0, 0, 1, e1}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0}},
                        {{99999999, 0, 432680, 0 | MINUS}},
                        {{UINT_MAX, 4312, 4291264512, 0}},
...
START_TEST(mul_all_9) {
    s21_decimal m1[] = {{{0, UINT_MAX, 0, e1}}, {{0, 1, 0, e1}}};
    s21_decimal m2[] = {{{1249184, 213, 1, 0}},
                        {{1453254535, 2123413241, 21367563, 0 | MINUS}},
                        {{99999999, 0, 432680, 0}},
                        {{5555, 9999999, 0, 0}},
...
START_TEST(div_all_0) {
    ...
    test_div(m4, m6, 1, size_m6);
}
END_TEST

START_TEST(div_all_1) {
    s21_decimal m4[] = {{{UINT_MAX, 0, 0, e1 * 15}}};
    s21_decimal m6[] = {{{1249184, 213, 1, e1 * 5}},
                        {{5555, 9999999, 0, e1 * 6 | MINUS}},
                        {{1, 0, 0, e1 * 15 | MINUS}},
                        {{UINT_MAX, UINT_MAX, UINT_MAX, MINUS}},
...
START_TEST(div_all_2) {
    s21_decimal m4[] = {{{0, UINT_MAX, 523798, e1 * 2 | MINUS}}};
    s21_decimal m6[] = {{{1249184, 213, 1, e1 * 5}},
                        {{1453254535, 2123413241, 21367563, e1 * 17}},
                        {{5555, 9999999, 0, e1 * 6 | MINUS}},
                        {{1, 0, 0, e1 * 15 | MINUS}},
...
START_TEST(div_all_3) {
    s21_decimal m4[] = {{{0, UINT_MAX, 100, e1 * 5}}};
    s21_decimal m6[] = {
        {{1249184, 213, 1, e1 * 5}},  {{UINT_MAX, UINT_MAX, UINT_MAX, MINUS}},
        {{UINT_MAX, 2, 12343214, 0}}, {{22222, 13, 132154, e1 * 4 | MINUS}},
        {{1, 0, 0, e1 * 15}},         {{2111111, 112312366, 121355, e1 * 15}}};
    int size_m6 = sizeof(m6) / sizeof(m6[0]);
    test_div(m4, m6, 1, size_m6);
}
END_TEST

START_TEST(div_all_4) {
    s21_decimal m4[] = {{{UINT_MAX, UINT_MAX, UINT_MAX, MINUS}}};
    s21_decimal m6[] = {
        {{1249184, 213, 1, e1 * 5}},  {{5555, 9999999, 0, e1 * 6 | MINUS}},
        {{1, 0, 0, e1 * 15 | MINUS}}, {{UINT_MAX, UINT_MAX, UINT_MAX, MINUS}},
        {{UINT_MAX, 2, 12343214, 0}}, {{1, 0, 0, e1 * 15}}};
    int size_m6 = sizeof(m6) / sizeof(m6[0]);
    test_div(m4, m6, 1, size_m6);
}
END_TEST

START_TEST(div_all_5) {
    s21_decimal m4[] = {{{0, 0, UINT_MAX, e1 * 16}}};
    s21_decimal m6[] = {{{1249184, 213, 1, e1 * 5}},
                        {{1453254535, 2123413241, 21367563, e1 * 17}},
                        {{5555, 9999999, 0, e1 * 6 | MINUS}},
                        {{UINT_MAX, 2, 12343214, 0}},
...
START_TEST(div_all_6) {
    s21_decimal m4[] = {{{0, 0, 100, MINUS}}};
    s21_decimal m6[] = {{{1249184, 213, 1, e1 * 5}},
                        {{5555, 9999999, 0, e1 * 6 | MINUS}},
                        {{UINT_MAX, 2, 12343214, 0}},
                        {{22222, 13, 132154, e1 * 4 | MINUS}},
...
Suite *s21_decimal_suite(void) {
    ...
    tcase_add_test(tc_test_add, add_all_0);
    tcase_add_test(tc_test_add, add_all_1);
    tcase_add_test(tc_test_add, add_all_2);
    tcase_add_test(tc_test_add, add_all_3);
    ...
    tcase_add_test(tc_test_sub, sub_all_0);
    tcase_add_test(tc_test_sub, sub_all_1);
    tcase_add_test(tc_test_sub, sub_all_2);
    tcase_add_test(tc_test_sub, sub_all_3);
    tcase_add_test(tc_test_sub, sub_all_4);
    tcase_add_test(tc_test_sub, sub_all_5);
    tcase_add_test(tc_test_sub, sub_all_6);
    tcase_add_test(tc_test_sub, sub_all_7);
    ...
    tcase_add_test(tc_test_mul, mul_all_0);
    tcase_add_test(tc_test_mul, mul_all_1);
    tcase_add_test(tc_test_mul, mul_all_2);
    tcase_add_test(tc_test_mul, mul_all_3);
    tcase_add_test(tc_test_mul, mul_all_4);
    tcase_add_test(tc_test_mul, mul_all_5);
    tcase_add_test(tc_test_mul, mul_all_6);
    tcase_add_test(tc_test_mul, mul_all_7);
    tcase_add_test(tc_test_mul, mul_all_8);
    tcase_add_test(tc_test_mul, mul_all_9);
    ...
    tcase_add_test(tc_test_div, div_all_0);
    tcase_add_test(tc_test_div, div_all_1);
    tcase_add_test(tc_test_div, div_all_2);
    tcase_add_test(tc_test_div, div_all_3);
    tcase_add_test(tc_test_div, div_all_4);
    tcase_add_test(tc_test_div, div_all_5);
    tcase_add_test(tc_test_div, div_all_6);
    ...
    tcase_add_test(tc_test_mod, mod_all);
    ...
    tcase_add_test(tc_test_equal, equal_all);
    ...
    tcase_add_test(tc_test_not_equal, not_equal_all);
    ...
    tcase_add_test(tc_test_less, less_all);
    ...
    tcase_add_test(tc_test_less_or_equal, less_eq_all);
    ...
    tcase_add_test(tc_test_greater, greater_all);
    ...
    tcase_add_test(tc_test_greater_or_equal, greater_eq_all);
    ...
    tcase_add_test(tc_test_int_to_dec, int_dec_all);
    ...
    tcase_add_test(tc_test_dec_to_int, dec_int_all);
    ...
    tcase_add_test(tc_test_float_to_dec, float_dec_all);
    ...
    tcase_add_test(tc_test_dec_to_float, dec_float_all_0);
    tcase_add_test(tc_test_dec_to_float, dec_float_all_1);
    ...
    tcase_add_test(tc_test_truncate, truncate_all_0);
    tcase_add_test(tc_test_truncate, truncate_all_1);
    ...
    tcase_add_test(tc_test_floor, floor_all_0);
    tcase_add_test(tc_test_floor, floor_all_1);
    tcase_add_test(tc_test_floor, floor_0);
    suite_add_tcase(suite, tc_test_floor);

    TCase *tc_test_negate = tcase_create("test_negate");
    tcase_add_test(tc_test_negate, negate_all_0);
    tcase_add_test(tc_test_negate, negate_all_1);
    ...
    tcase_add_test(tc_test_round, round_all_0);
    tcase_add_test(tc_test_round, round_all_1);
